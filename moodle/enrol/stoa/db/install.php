...
function xmldb_enrol_stoa_install() {
    ...
    if (isset($CFG->enrol_db_category)) {
        set_config('defaultcategory', $CFG->enrol_db_category, 'enrol_stoa');
        unset_config('enrol_db_category');
    }
    if (isset($CFG->enrol_db_template)) {
        set_config('templatecourse', $CFG->enrol_db_template, 'enrol_stoa');
        unset_config('enrol_db_template');
    }
    if (isset($CFG->enrol_db_ignorehiddencourse)) {
        set_config('ignorehiddencourses', $CFG->enrol_db_ignorehiddencourse, 'enrol_stoa');
    ...
    if (!$DB->record_exists('enrol', array('enrol'=>'stoa'))) {
        role_unassign_all(array('component'=>'enrol_stoa'));
        return;
    }
}
