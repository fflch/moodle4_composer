...
/**
 * Stoa enrolment plugin - support for user  unenrolment.
 * Adapted from self enrolment plugin Ewout ter Haar <ewout@usp.br> 2013
 *
 * @package    enrol_stoa
...
$PAGE->set_url('/enrol/stoa/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_stoa', format_string($course->fullname));
